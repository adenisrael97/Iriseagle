...
const STATIC_PAGES = [
  ...
  { route: PAGE_ROUTES.contact, changeFreq: "monthly", lastMod: NOW },
  { route: PAGE_ROUTES.financing, changeFreq: "monthly", lastMod: NOW },
  { route: PAGE_ROUTES.preorder, changeFreq: "weekly", lastMod: NOW },
  { route: PAGE_ROUTES.about, changeFreq: "monthly", lastMod: NOW },
  { route: PAGE_ROUTES.blog, changeFreq: "weekly", lastMod: NOW },
  { route: PAGE_ROUTES.afterSales, changeFreq: "monthly", lastMod: NOW },
  { route: PAGE_ROUTES.history, changeFreq: "yearly", lastMod: NOW },
];
...
export default function sitemap() {
  ...
  const vehicleRoutes = VEHICLE_ENTRIES.map(({ slug }) => ({
