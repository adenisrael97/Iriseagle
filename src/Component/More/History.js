...
import { FaFlagCheckered, FaCarSide, FaAward, FaUsers } from "react-icons/fa";
  ...
  const milestones = [
    {
      ...
      icon: <FaFlagCheckered className="text-red-700 text-3xl mb-2" />,
    },
    {
      year: "2015",
      title: "Expansion",
      ...
      icon: <FaCarSide className="text-red-700 text-3xl mb-2" />,
    },
    {
      year: "2019",
      ...
      icon: <FaAward className="text-red-700 text-3xl mb-2" />,
    },
    {
      year: "2024",
      ...
      icon: <FaUsers className="text-red-700 text-3xl mb-2" />,
    },
  ];
    ...
    <>
      ...
      <div className="w-full max-w-4xl mx-auto mt-8 mb-16 px-4">
        <motion.h1
          ...
          className="text-3xl md:text-4xl font-bold text-red-700 text-center mb-10 flex items-center justify-center gap-3"
        >
          <FaFlagCheckered className="text-red-700 text-2xl" /> Founded 2012
        </motion.h1>
