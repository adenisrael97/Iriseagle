      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-10">
        <div className="flex flex-col lg:flex-row gap-6 w-full max-w-6xl">
          ...
          <div className="flex-1 bg-white rounded-2xl shadow-2xl p-6 xs:p-8 md:p-10 flex flex-col items-center text-center">
            ...
            <div className="mb-6">
              <FaSearch className="text-red-600 w-16 h-16 xs:w-20 xs:h-20 md:w-24 md:h-24" />
            </div>
          ...
          <div className="flex-1 bg-red-500/80 backdrop-blur-sm rounded-2xl shadow-2xl p-6 xs:p-8 md:p-10 flex flex-col items-center text-center">
            ...
            <div className="mb-6">
              <FaCar className="text-white w-16 h-16 xs:w-20 xs:h-20 md:w-24 md:h-24" />
            </div>
            ...
            <button className="bg-white hover:bg-gray-100 text-red-600 font-bold px-8 py-3 rounded-md text-base md:text-lg transition-colors shadow-lg">
              Pre-order Now
            </button>
          </div>
        </div>
